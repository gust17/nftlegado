                ...
                <div class="col-md-6" style="display: flex !important; justify-content:center !important; align-items:center !important">
                    ...
                    <div style="">
                        ...
                        <div class="text-center">
                            <h4 class="mb-3 text-center text-white f-w-600"><?php echo sprintf($this->lang->line('recuperar_titulo'), NOME_SITE);?></h4>
                            <p class="text-white text-center mb-4"><?php echo $this->lang->line('recuperar_inst');?></p>
                        </div>
                    </div>
					...
					<div class="card-body">
                        <form action="" method="post">                           
                            ...
                            <div class="text-right">
                                <button type="submit" name="submit" value="Recuperar Senha" class="btn btn-primary mt-2 btn-block"><?php echo $this->lang->line('recuperar_recuperar_button');?></button>
