                ...
                <div class="card-body">
                    <div class="row align-items-center m-b-25">
                        <div class="col">
                            ...
                            <h3 class="m-b-0 text-white"><?php echo MOEDA;?> <?php echo number_format($saldo_backoffice, 2, ',', '.');?></h3>
                        </div>
                        <div class="col-auto">
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-12">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" name="valor_1" placeholder="<?php echo $this->lang->line('saq_informe_valor');?>">
                                        </div>
                                    </div>
                                </div>
                            </div>
