                ...
                <div class="card-body">
                    <div class="row align-items-center m-b-25">
                        <div class="col">
                            ...
                            <h3 class="m-b-0 text-white"><?php echo MOEDA;?> <?php echo number_format(($saldo_raiz - ($saldo_raiz * ($taxa_raiz/100))), 2, ',', '.');?></h3>
                        </div>
                        <div class="col-auto">
                            <i class="fas fa-dollar-sign text-white"></i>
                        </div>
                    </div>
                    <p class="m-b-0 text-white"><?php echo sprintf($this->lang->line('saq_valor_raiz_sacar_taxa_desc'), $taxa_raiz);?></p>
                </div>
            </div>
        </div>
    </div>
