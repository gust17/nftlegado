            ...
            <div class="card prod-p-card bg-warning">
                <div class="card-body">
                    <div class="row align-items-center m-b-25">
                        <div class="col">
                            <h6 class="m-b-5 text-white"><?php echo $this->lang->line('saq_valor_raiz');?></h6>
                            <h3 class="m-b-0 text-white"><?php echo MOEDA;?> <?php echo number_format($saldo_raiz, 2, ',', '.');?></h3>
                        </div>
                        <div class="col-auto">
                            <i class="fas fa-dollar-sign text-white"></i>
                        </div>
                    </div>
                    <p class="m-b-0 text-white"><?php echo $this->lang->line('saq_valor_raiz_desc');?></p>
                </div>
            </div>
        </div>
        <div class="col-md-6">
            <div class="card prod-p-card bg-success">
                <div class="card-body">
                    <div class="row align-items-center m-b-25">
                        <div class="col">
                            <h6 class="m-b-5 text-white"><?php echo $this->lang->line('saq_valor_raiz_sacar_taxa');?></h6>
                            <h3 class="m-b-0 text-white"><?php echo MOEDA;?> <?php echo number_format(($saldo_raiz - ($saldo_raiz * ($cancelamento_taxa/100))), 2, ',', '.');?></h3>
                        </div>
                        <div class="col-auto">
                            <i class="fas fa-dollar-sign text-white"></i>
                        </div>
                    </div>
                    <p class="m-b-0 text-white"><?php echo sprintf($this->lang->line('saq_valor_raiz_sacar_taxa_desc'), $cancelamento_taxa);?></p>
                </div>
            </div>
        </div>
    </div>
                            ...
                            <div class="tab-pane fade" id="v-pills-pix" role="tabpanel" aria-labelledby="v-pills-pix-tab">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped">
                                        ...
                                        <tr>
                                            <td><strong><?php echo $this->lang->line('saq_form_pix_banco');?></strong></td>
                                            <td>
                                            <?php
                                            $pixArray = json_decode($pix, true);
