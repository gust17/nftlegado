        ...
        <div class="card-body table-border-style">
            <div class="table-responsive dt-responsive">
                <table class="table simpletable">
                    <thead>
                        <tr>
                            <th><?php echo $this->lang->line('ind_ativos_form_nome');?></th>
                            <th><?php echo $this->lang->line('ind_ativos_form_celular');?></th>
                            <th><?php echo $this->lang->line('ind_ativos_form_data_cadastro');?></th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php
