  ...
  <center role="article" aria-roledescription="email" lang="en" style="width: 100%; background-color: #F9F9F9;">
    ...
    <![endif]-->
        ...
        <div style="max-height:0; overflow:hidden; mso-hide:all;" aria-hidden="true">
            Boas notícias! Seu saque foi pago com sucesso!
        </div>
                    ...
                    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                        <tr>
                            <td style="padding: 20px; font-family: 'Poppins', sans-serif; font-size: 15px; line-height: 20px; color: #555555;">
                                <h1 style="margin: 0 0 10px; font-size: 25px; line-height: 30px; color: #333333; font-weight: normal;text-align:center;">Sua solicitação foi PAGA!</h1>
								<p style="margin: 0 0 10px;text-align:center;color:#999;font-size:16px;">
                                    Olá, sua solicitação de saque ID #<?php echo $id;?> no valor de <?php echo MOEDA;?> <b><?php echo number_format($valor, 2, ',', '.');?></b> acaba de ser paga! <br />
                                    Verifique sua conta para confirmar a transação.
								</p>
                            </td>
                        </tr>
                        <tr>
                                ...
                                <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" style="margin: auto;">
                                    <tr>
                                        <td class="button-td button-td-primary" style="border-radius: 4px; background: #F5E058;border-radius:50px !important;">
											<a class="button-a button-a-primary" href="<?php echo base_url($rotas->login);?>" style="background: #F5E058; border-radius:50px !important; text-transform: uppercase; font-family: 'Poppins', sans-serif; font-size: 15px; font-weight: 400; line-height: 15px; text-decoration: none; padding: 13px 17px; color: #F48621; display: block;">Clique aqui para acessar sua conta</a>
										</td>
                                    </tr>
                                </table>
                                <!-- Button : END -->
